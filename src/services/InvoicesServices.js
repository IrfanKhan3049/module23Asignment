...
const pamentSettingModel = require("../models/pamentSettingModel");
...
const PaymentSuccessService = async (req)=>{
  ...
  try{
    ...
    await InvoiceModel.updateOne({tran_id:trxID},{pyment_status:"success"});
...
const PaymentFailService = async (req)=>{
  ...
  try{
    let trxID=req.params.trxID;
    await InvoiceModel.updateOne({tran_id:trxID},{pyment_status:"fail"});
    return {status:"fail",}
  }catch(e){
    return {status:"fail",message:"Something went wrong"}
  }
...
const PaymentCancelService = async (req)=>{
  ...
  try{
    let trxID=req.params.trxID;
    await InvoiceModel.updateOne({tran_id:trxID},{pyment_status:"cancel"});
...
const PaymentIPNService = async (req)=>{
  ...
  try{
    ...
    await InvoiceModel.updateOne({tran_id:trxID},{pyment_status:status});
...
const InvoiceProductListService = async (req)=>{
  ...
  try{
    ...
    //let invoice_id= req.headers.invoice_id;
